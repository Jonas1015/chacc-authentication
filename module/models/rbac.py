...
DEFAULT_PRIVILEGES = [
    {
        "name": "ALL",
        "description": "Super user privilege that grants all access",
        "severity": "CRITICAL",
    },
    {
    ...
    {
        "name": "WRITE_USERS",
        "description": "Modify any user profile",
        "severity": "HIGH",
    },
    {
        "name": "READ_ROLES",
        "description": "Read roles and assignments",
        "severity": "MEDIUM",
    },
    ...
    {"name": "READ_PRIVILEGES", "description": "Read privileges", "severity": "MEDIUM"},
    {
        ...
        "description": "Create/modify privileges",
        "severity": "VERY HIGH",
    },
    {
        "name": "MANAGE_SYSTEM",
    ...
    {
        "name": "READ_ROLE_GROUPS",
        "description": "Read role groups",
        "severity": "MEDIUM",
    },
    {
        "name": "WRITE_ROLE_GROUPS",
        "description": "Create/modify role groups",
        "severity": "HIGH",
    },
    {
        "name": "WRITE_USER_ROLES",
        "description": "Assign roles to users",
        "severity": "HIGH",
    },
    {
        "name": "WRITE_USER_PRIVILEGES",
        "description": "Assign direct privileges to users",
        "severity": "HIGH",
    },
    {
        "name": "READ_USER_PRIVILEGES",
        "description": "View user's effective privileges",
        "severity": "MEDIUM",
    },
    {
        "name": "READ_PASSWORD_POLICY",
        "description": "View password policy",
        "severity": "MEDIUM",
    },
    {
        "name": "WRITE_PASSWORD_POLICY",
